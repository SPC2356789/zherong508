    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative"
                 data-dot="<img src='{{ asset('arkitektur/img/carousel-1.jpg')}}'>">
                <img class="img-fluid" src="{{ asset('arkitektur/img/carousel-1.jpg')}}" alt="">
            ...
            <div class="owl-carousel-item position-relative"
                 data-dot="<img src='{{ asset('arkitektur/img/carousel-2.jpg')}}'>">
                <img class="img-fluid" src="{{ asset('arkitektur/img/carousel-2.jpg')}}" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="owl-carousel-item position-relative"
                 data-dot="<img src='{{ asset('arkitektur/img/carousel-3.jpg')}}'>">
                <img class="img-fluid" src="{{ asset('arkitektur/img/carousel-3.jpg')}}" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="{{ asset('arkitektur/img/icons/icon-2.png')}}" alt="Icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="{{ asset('arkitektur/img/icons/icon-3.png')}}" alt="Icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="{{ asset('arkitektur/img/icons/icon-4.png')}}" alt="Icon">
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="{{ asset('arkitektur/img/about-1.jpg')}}" alt="">
                        <img class="img-fluid" src="{{ asset('arkitektur/img/about-2.jpg')}}" alt="">
                    </div>
                </div>
